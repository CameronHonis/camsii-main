...
export default function OptionsShowcase() {
    return <div className="flex bg-camsii-offwhite p-[10px] justify-between">
        <div className="flex-grow flex flex-col items-center justify-between p-[30px] pt-[70px] bg-gradient-to-b from-[#D8A0B1] to-[#986373] h-[625px]">
        ...
        <div className="relative flex-grow ml-[10px] flex flex-col justify-between items-center p-[30px] pt-[110px] bg-gradient-to-b from-[#222222] to-[#111111]">
